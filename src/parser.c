...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [8] = {.lex_state = 562, .external_lex_state = 2},
  [9] = {.lex_state = 561, .external_lex_state = 2},
  [10] = {.lex_state = 562, .external_lex_state = 2},
  [11] = {.lex_state = 561, .external_lex_state = 2},
  [12] = {.lex_state = 0, .external_lex_state = 2},
  [13] = {.lex_state = 562, .external_lex_state = 3},
  [14] = {.lex_state = 0, .external_lex_state = 1},
  [15] = {.lex_state = 561, .external_lex_state = 3},
  ...
  [28] = {.lex_state = 561, .external_lex_state = 3},
  ...
  [33] = {.lex_state = 561, .external_lex_state = 3},
  [34] = {.lex_state = 559, .external_lex_state = 3},
